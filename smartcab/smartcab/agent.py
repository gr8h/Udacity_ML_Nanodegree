...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = max(0, math.pow(math.e, - 0.005 * self.t))
            self.alpha = max(0, 1.0/(1 + 0.5*self.t))
    ...
    def learn(self, state, action, reward):
        ...
        """
        Equation: Q(s,a) = Q(s,a) + alpha * ( r + gamma + next_maxQ)
        """
        # Get old Q
        ...
        # Learn the new Q
        # Gamma removed
        newQ = oldQ + self.alpha * (reward + new_maxQ)
